...
if($objGeoposicionamiento->exist()) {
	...
	echo json_encode(array(
		...
		, 'longitud'=>$objGeoposicionamiento->longitud
		, 'latitud'=>$objGeoposicionamiento->latitud
		, 'fechahora'=>$objGeoposicionamiento->fechahora
		, 'glosa'=>$objGeoposicionamiento->glosa
	));
}
